...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.content.context_processors.announcement_bars",
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@wonzayskollections.com.au")
...
MAILCHIMP_WEBHOOK_URL = env("MAILCHIMP_WEBHOOK_URL", default="")

# AWS S3 (production only — see production.py)
